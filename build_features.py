...
CITY = SITE_CFG.get("city", "")                # 例: 神戸市 / 神戸市 / 北播磨エリア
SITE_NAME = SITE_CFG.get("site_name", "")      # 例: 神戸歯科総研
EN_UPPER = SITE_CFG.get("site_name_en", "")    # 例: KOBE DENTAL RESEARCH
# 例: Kobe Dental Research Institute（site_name_enから機械導出。ハイフン語は各パートを大文字化）
...
# ファイル名は集約先の実ファイル名（旧・神戸表記）で固定し、article_href()がローカルに実ファイルが
# あるサイト（神戸）は相対リンク、無いサイト（複製都市）は集約先への絶対URLを返す。
# CITY_SHORT等で組み立てると複製都市で存在しないファイル名を生成しリンク切れになる（validate_release G-6）。
CATEGORY_ARTICLES = {
    "ct":       [("2026-07-04_CTとマイクロスコープがある神戸の歯科を選ぶ理由.html", "CTとマイクロスコープがある歯科が重要な理由"),
                 ("2026-07-04_根管治療が上手い神戸の歯科医院を見分ける方法.html", "根管治療が上手い歯科の見分け方｜専門医の選び方")],
    "micro":    [("2026-07-04_CTとマイクロスコープがある神戸の歯科を選ぶ理由.html", "CTとマイクロスコープがある歯科が重要な理由"),
                 ("2026-07-04_根管治療が上手い神戸の歯科医院を見分ける方法.html", "根管治療が上手い歯科の見分け方｜専門医の選び方")],
    "implant":  [("2026-07-04_神戸のインプラント費用とリスクを正しく理解する.html", "インプラント｜費用相場とリスクを正しく理解する")],
    "ortho":    [("2026-07-04_神戸で矯正は何歳から？選び方を徹底解説.html", "矯正は何歳から？マウスピース・ワイヤーの選び方"),
                 ("2026-07-04_歯並びが気になったら｜神戸で矯正相談すべきタイミング.html", "歯並びが気になる方へ｜矯正相談するベストタイミング")],
    "kids":     [("2026-07-04_子どもの虫歯予防｜神戸の小児歯科はいつから？.html", "子どもの虫歯予防｜小児歯科にいつから通うべきか"),
                 ("2026-07-04_神戸で矯正は何歳から？選び方を徹底解説.html", "矯正は何歳から？マウスピース・ワイヤーの選び方")],
    "prevent":  [("2026-07-04_予防歯科クリーニングの頻度とメリット｜神戸市版.html", "予防歯科のクリーニング頻度とメリット"),
                 ("2026-07-04_子どもの虫歯予防｜神戸の小児歯科はいつから？.html", "子どもの虫歯予防｜小児歯科にいつから通うべきか")],
    "esthetic": [("2026-07-04_神戸ホワイトニング｜種類・費用・選び方を徹底比較.html", "ホワイトニング｜種類・選び方・費用比較ガイド"),
                 ("2026-07-04_銀歯を白くしたい！神戸でセラミック治療の費用と方法.html", "銀歯を白くしたい方へ｜セラミック費用と方法を解説")],
    "kids_fit": [("2026-07-04_子どもの虫歯予防｜神戸の小児歯科はいつから？.html", "子どもの虫歯予防｜小児歯科にいつから通うべきか")],
}

SHARED_ARTICLES_BASE = "https://kobe.shikasoken.com/articles/"  # コラム集約先（横展開マニュアル §8）

def article_href(fname):
    """関連記事のリンク先。ローカルに実ファイルがあれば相対、無ければ集約先の絶対URL。"""
    from urllib.parse import quote
    if os.path.exists(os.path.join(ROOT, "articles", fname)):
        return f"../{fname}"  # 神戸＝従来どおりの相対リンク（出力不変）
