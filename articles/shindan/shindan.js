...
// ── エリア定義（神戸市9区） ──────
const AREA_KEYWORDS = {
  "中央区（三宮・元町）":       ["神戸市中央区", "中央区", "三宮", "元町"],
  "東灘区（岡本・住吉）":       ["神戸市東灘区", "東灘区", "岡本", "住吉"],
  "灘区（六甲道・王子公園）":   ["神戸市灘区", "灘区", "六甲道", "王子公園"],
  "兵庫区（新開地・兵庫駅）":   ["神戸市兵庫区", "兵庫区", "新開地", "兵庫駅"],
  "北区（鈴蘭台・岡場）":       ["神戸市北区", "北区", "鈴蘭台", "岡場"],
  "長田区（新長田・高速長田）": ["神戸市長田区", "長田区", "新長田", "高速長田"],
  "須磨区（名谷・板宿）":       ["神戸市須磨区", "須磨区", "名谷", "板宿"],
  "垂水区（垂水・舞子）":       ["神戸市垂水区", "垂水区", "垂水", "舞子"],
  "西区（西神中央・学園都市）": ["神戸市西区", "西区", "西神中央", "学園都市"],
};
...
const WARD_RE = /神戸市([一-龥]+区)/; // nullの場合は市全体で順位を出す
