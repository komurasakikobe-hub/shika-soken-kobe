...
const AREA_KEYWORDS = {
  "東灘区（摂津本山・住吉）": ["神戸市東灘区", "東灘区"],
  "中央区（旧居留地・春日野道）": ["神戸市中央区", "中央区"],
  "垂水区（山陽垂水・学園都市）": ["神戸市垂水区", "垂水区"],
  "灘区（六甲・六甲道）": ["神戸市灘区", "灘区"],
  "西区（西神中央・西明石）": ["神戸市西区", "西区"],
  "須磨区（板宿・名谷）": ["神戸市須磨区", "須磨区"],
  "北区（西鈴蘭台・北鈴蘭台）": ["神戸市北区", "北区"],
  "長田区（高速長田・新長田）": ["神戸市長田区", "長田区"],
  "兵庫区（湊川・大開）": ["神戸市兵庫区", "兵庫区"],
};
