...
// ── エリア定義（大阪市24区。旧ウィザードのAREA_KEYWORDSを再利用） ──────
const AREA_KEYWORDS = {
  "北区（梅田・大阪駅）":       ["大阪市北区", "北区", "梅田"],
  "中央区（心斎橋・難波）":     ["大阪市中央区", "中央区", "心斎橋", "難波"],
  "西区（本町・阿波座）":       ["大阪市西区", "西区", "本町", "阿波座"],
  "福島区（福島・野田）":       ["大阪市福島区", "福島区", "福島", "野田"],
  "天王寺区（天王寺・上本町）": ["大阪市天王寺区", "天王寺区", "天王寺", "上本町"],
  "阿倍野区（阿倍野橋・昭和町）": ["大阪市阿倍野区", "阿倍野区", "阿倍野", "昭和町"],
  "浪速区（なんば・新今宮）":   ["大阪市浪速区", "浪速区", "なんば", "新今宮"],
  "淀川区（新大阪・十三）":     ["大阪市淀川区", "淀川区", "新大阪", "十三"],
  "東淀川区（東淀川・上新庄）": ["大阪市東淀川区", "東淀川区", "東淀川", "上新庄"],
  "都島区（京橋・桜ノ宮）":     ["大阪市都島区", "都島区", "京橋", "桜ノ宮"],
  "此花区（桜島・西九条）":     ["大阪市此花区", "此花区", "桜島", "西九条"],
  "港区（弁天町・朝潮橋）":     ["大阪市港区", "港区", "弁天町", "朝潮橋"],
  "大正区（大正・鶴町）":       ["大阪市大正区", "大正区", "大正", "鶴町"],
  "西淀川区（姫島・出来島）":   ["大阪市西淀川区", "西淀川区", "姫島", "出来島"],
  "東成区（今里・玉造）":       ["大阪市東成区", "東成区", "今里", "玉造"],
  "生野区（鶴橋・桃谷）":       ["大阪市生野区", "生野区", "鶴橋", "桃谷"],
  "旭区（千林・関目）":         ["大阪市旭区", "旭区", "千林", "関目"],
  "城東区（蒲生・野江）":       ["大阪市城東区", "城東区", "蒲生", "野江"],
  "鶴見区（横堤・放出）":       ["大阪市鶴見区", "鶴見区", "横堤", "放出"],
  "住之江区（住之江・南港）":   ["大阪市住之江区", "住之江区", "住之江", "南港"],
  "住吉区（我孫子・長居）":     ["大阪市住吉区", "住吉区", "我孫子", "長居"],
  "東住吉区（田辺・針中野）":   ["大阪市東住吉区", "東住吉区", "田辺", "針中野"],
  "平野区（平野・喜連瓜破）":   ["大阪市平野区", "平野区", "平野", "喜連瓜破"],
  "西成区（天下茶屋・花園町）": ["大阪市西成区", "西成区", "天下茶屋", "花園町"],
};
const WARD_LIST = [{ key: "all", label: "大阪市全体" }].concat(
...
function cardHTML(clinic, rank, matched) {
  const addr = clinic.address || "";
  const wardMatch = addr.match(/大阪市([一-龥]+区)/);
...
function renderCurrentFilterPanel() {
  ...
  if (chips.length === 0) {
    panel.innerHTML = `<p class="rk-panel-empty">大阪市全体・総合データ順</p>`;
  } else {
